...
<script src="[{$oViewConf->getResourceUrl()}]mercury/javascripts/oxid_mercury.js" type="text/javascript"></script>
<script src="[{$oViewConf->getResourceUrl()}]mercury/javascripts/mercury_loader.js" type="text/javascript"></script>
[{/if}]
